...
## 📊 TABLA COMPARATIVA V2.0 vs V3.0

| Aspecto | V2.0 | V3.0 |
|---------|------|------|
| Memoria entre fases | Decorativa (texto sin persistencia) | BCO obligatorio con validación |
| Fase 2C | 1 bloque de 35-50 págs (causa colapso) | 4 subfases de 5-12 págs cada una |
| Variables | Sin control de consistencia | Ficha canónica inmutable en BCO |
| Referencias | Rangos asignados sin verificar | Mapa de Fase 1 como fuente de verdad |
| Cortes/interrupciones | Sin protocolo | Protocolo de recuperación explícito |
| Mapeo OE→Resultado→Conclusión | Implícito | Explícito y verificado por checklist |
| Validación al inicio de fase | Cosmética | Obligatoria con bloqueo si falta BCO |
| Checks de auto-corrección | 14 items | 17 items (+3 anti-amnesia) |
| Fases totales | 7 (0,1,2A,2B,2C,2D,3,4) | 10 (0,1,2A,2B,2C-1,2C-2,2C-3,2C-4,2D,3,4) |
